    ...
    <>
      {!open && (
        <div className="flex items-center text-sm mt-2">
          <span>{currentActiveCategoriesName} </span>
      ...
      {open && (
        <>
          <div className="relative overflow-auto" ref={categorySelectorRef}>
            <div className="flex w-[500px] sm:w-full border border-gray-700 rounded divide-x divide-gray-700 shadow-sm sm:text-sm">
