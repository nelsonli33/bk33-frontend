...
export default function AppFrame({ children }) {
  ...
  return (
    <div className="min-h-full">
                  ...
                  >
                    <item.icon
                      className={classNames(
                        ...
                        "mr-3 flex-shrink-0 h-6 w-6 stroke-1"
                      )}
                      aria-hidden="true"
                    />
                    {item.name}
      ...
      {/* Main column */}
      <div className="lg:pl-64 flex flex-col items-stretch flex-1 h-full">
        {/* Search header */}
        ...
        <main className="flex flex-col items-stretch flex-1">{children}</main>
      </div>
      <style global jsx>{`
        html,
        body,
